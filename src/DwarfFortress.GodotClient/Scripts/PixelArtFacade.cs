...
public static class PixelArtFactory
{
    ...
    public static readonly bool UseSprites = ParseUseSpritesFlag();
    ...
    public static Texture2D GetTile(string tileDefId, string? materialId = null)
    {
        ...
        if (Cache.TryGetValue(key, out var cached)) return cached;
        if (UseSprites && SpriteRegistry.TryGetTile(tileDefId, out var sprite) && sprite is not null) return Cache[key] = sprite;
        return Cache[key] = tileDefId switch
        {
            ...
            _ => MakeStoneFloor(new Color(0.48f, 0.48f, 0.52f), new Color(0.36f, 0.36f, 0.40f), new Color(0.64f, 0.64f, 0.70f)),
        };
    }
    ...
    public static Texture2D GetPlantOverlay(string plantDefId, byte growthStage, byte yieldLevel = 0, byte seedLevel = 0)
    {
        ...
        return Cache[key] = MakePlantOverlay(plantDefId, growthStage, yieldLevel, seedLevel);
    }
    ...
    private static Texture2D MakePlantOverlay(string plantDefId, byte growthStage, byte yieldLevel, byte seedLevel)
    {
        var image = NewImage();
        var (stem, leaf, accent, outline, canopy) = ResolvePlantPalette(plantDefId);
    ...
    private static (Color Stem, Color Leaf, Color Accent, Color Outline, bool Canopy) ResolvePlantPalette(string plantDefId)
        => plantDefId switch
        {
            "berry_bush" => (new Color(0.22f, 0.40f, 0.14f), new Color(0.28f, 0.58f, 0.24f), new Color(0.74f, 0.18f, 0.42f), new Color(0.08f, 0.18f, 0.09f, 0.95f), false),
            "sunroot" => (new Color(0.38f, 0.30f, 0.12f), new Color(0.38f, 0.68f, 0.22f), new Color(0.94f, 0.78f, 0.22f), new Color(0.16f, 0.20f, 0.08f, 0.95f), false),
            "stone_tuber" => (new Color(0.36f, 0.30f, 0.16f), new Color(0.44f, 0.60f, 0.32f), new Color(0.66f, 0.60f, 0.46f), new Color(0.13f, 0.16f, 0.09f, 0.95f), false),
            "marsh_reed" => (new Color(0.26f, 0.42f, 0.18f), new Color(0.36f, 0.72f, 0.28f), new Color(0.86f, 0.72f, 0.38f), new Color(0.07f, 0.16f, 0.08f, 0.95f), false),
            "apple_canopy" => (new Color(0.22f, 0.34f, 0.14f), new Color(0.28f, 0.62f, 0.22f), new Color(0.88f, 0.16f, 0.12f), new Color(0.08f, 0.16f, 0.08f, 0.95f), true),
            "fig_canopy" => (new Color(0.24f, 0.34f, 0.18f), new Color(0.38f, 0.62f, 0.28f), new Color(0.62f, 0.22f, 0.48f), new Color(0.08f, 0.16f, 0.08f, 0.95f), true),
            _ => (new Color(0.24f, 0.40f, 0.16f), new Color(0.34f, 0.62f, 0.24f), new Color(0.88f, 0.72f, 0.32f), new Color(0.08f, 0.16f, 0.08f, 0.95f), false),
        };
    ...
    public static Texture2D GetEntity(string id)
    {
        var key = $"entity:{id}";
        if (Cache.TryGetValue(key, out var cached)) return cached;
        if (UseSprites && SpriteRegistry.TryGetEntity(id, out var sprite) && sprite is not null) return Cache[key] = sprite;
        return Cache[key] = id switch
        {
            DefIds.Dwarf => GetDwarf(DefaultDwarfAppearance),
            DefIds.Goblin => MakeGoblin(),
            DefIds.Troll => MakeTroll(),
            DefIds.Elk => MakeElk(),
            DefIds.GiantCarp => MakeGiantCarp(),
            DefIds.Cat => MakeCat(),
            DefIds.Dog => MakeDog(),
            _ => MakeCreatureFromId(id),
        };
    }

    public static Texture2D GetItem(string itemDefId)
    {
        var key = $"item:{itemDefId}";
        if (Cache.TryGetValue(key, out var cached)) return cached;
        if (UseSprites && SpriteRegistry.TryGetItem(itemDefId, out var sprite) && sprite is not null) return Cache[key] = sprite;
        return Cache[key] = itemDefId switch
        {
            ItemDefIds.Log => MakeLog(),
            ItemDefIds.Plank => MakePlank(),
            ItemDefIds.GraniteBoulder => MakeBoulder(new Color(0.50f, 0.52f, 0.58f), new Color(0.72f, 0.74f, 0.80f), new Color(0.26f, 0.28f, 0.34f)),
            ItemDefIds.LimestoneBoulder => MakeBoulder(new Color(0.74f, 0.72f, 0.63f), new Color(0.88f, 0.86f, 0.77f), new Color(0.48f, 0.45f, 0.38f)),
            ItemDefIds.SandstoneBoulder => MakeBoulder(new Color(0.70f, 0.60f, 0.42f), new Color(0.83f, 0.74f, 0.55f), new Color(0.43f, 0.32f, 0.21f)),
            ItemDefIds.BasaltBoulder => MakeBoulder(new Color(0.36f, 0.36f, 0.40f), new Color(0.56f, 0.56f, 0.61f), new Color(0.20f, 0.20f, 0.24f)),
            ItemDefIds.ShaleBoulder => MakeBoulder(new Color(0.44f, 0.42f, 0.40f), new Color(0.62f, 0.60f, 0.56f), new Color(0.25f, 0.23f, 0.21f)),
            ItemDefIds.SlateBoulder => MakeBoulder(new Color(0.40f, 0.43f, 0.47f), new Color(0.58f, 0.62f, 0.68f), new Color(0.22f, 0.24f, 0.28f)),
            ItemDefIds.MarbleBoulder => MakeBoulder(new Color(0.80f, 0.80f, 0.82f), new Color(0.92f, 0.92f, 0.94f), new Color(0.56f, 0.56f, 0.60f)),
            ItemDefIds.IronOre => MakeOreChunk(new Color(0.42f, 0.44f, 0.48f), new Color(0.70f, 0.72f, 0.78f)),
            ItemDefIds.CopperOre => MakeOreChunk(new Color(0.42f, 0.36f, 0.33f), new Color(0.79f, 0.46f, 0.25f)),
            ItemDefIds.CoalOre => MakeOreChunk(new Color(0.16f, 0.16f, 0.18f), new Color(0.36f, 0.36f, 0.40f)),
            ItemDefIds.TinOre => MakeOreChunk(new Color(0.44f, 0.44f, 0.46f), new Color(0.75f, 0.78f, 0.82f)),
            ItemDefIds.SilverOre => MakeOreChunk(new Color(0.48f, 0.48f, 0.52f), new Color(0.86f, 0.88f, 0.92f)),
            ItemDefIds.GoldOre => MakeOreChunk(new Color(0.46f, 0.40f, 0.26f), new Color(0.95f, 0.82f, 0.32f)),
            ItemDefIds.IronBar => MakeIngot(new Color(0.72f, 0.74f, 0.80f), new Color(0.46f, 0.48f, 0.54f)),
            ItemDefIds.CopperBar => MakeIngot(new Color(0.83f, 0.51f, 0.30f), new Color(0.52f, 0.28f, 0.15f)),
            ItemDefIds.TinBar => MakeIngot(new Color(0.80f, 0.84f, 0.88f), new Color(0.52f, 0.56f, 0.60f)),
            ItemDefIds.SilverBar => MakeIngot(new Color(0.88f, 0.90f, 0.94f), new Color(0.58f, 0.60f, 0.66f)),
            ItemDefIds.GoldBar => MakeIngot(new Color(0.95f, 0.82f, 0.36f), new Color(0.62f, 0.46f, 0.14f)),
            ItemDefIds.Meal => MakeMeal(),
            ItemDefIds.Drink => MakeDrink(),
            ItemDefIds.Seed => MakeSeeds(),
            ...
            ItemDefIds.SunrootSeed    => MakeSeeds(),
            ItemDefIds.StoneTuberSeed => MakeSeeds(),
            ItemDefIds.MarshReedSeed  => MakeSeeds(),
            ItemDefIds.AppleSeed      => MakeSeeds(),
            ItemDefIds.FigSeed        => MakeSeeds(),
            ...
            _ => MakeCrate(new Color(0.64f, 0.64f, 0.64f)),
        };
    }
    ...
    public static Texture2D GetBuilding(string buildingDefId)
    {
        ...
        if (Cache.TryGetValue(key, out var cached)) return cached;
        if (UseSprites && SpriteRegistry.TryGetBuilding(buildingDefId, out var sprite) && sprite is not null) return Cache[key] = sprite;
        return Cache[key] = buildingDefId switch
        {
            "carpenter_workshop" => MakeWorkshop(new Color(0.64f, 0.43f, 0.22f), new Color(0.34f, 0.20f, 0.10f), new Color(0.82f, 0.73f, 0.58f)),
            "smelter" => MakeWorkshop(new Color(0.46f, 0.48f, 0.52f), new Color(0.22f, 0.24f, 0.28f), new Color(0.95f, 0.54f, 0.16f)),
            "kitchen" => MakeWorkshop(new Color(0.73f, 0.68f, 0.54f), new Color(0.42f, 0.35f, 0.20f), new Color(0.47f, 0.72f, 0.31f)),
            "still" => MakeWorkshop(new Color(0.58f, 0.54f, 0.62f), new Color(0.30f, 0.26f, 0.34f), new Color(0.34f, 0.72f, 0.86f)),
            "bed" => MakeBed(),
            "table" => MakeTable(),
            "chair" => MakeChair(),
            _ => MakeWorkshop(new Color(0.78f, 0.55f, 0.22f), new Color(0.40f, 0.26f, 0.10f), new Color(0.90f, 0.86f, 0.72f)),
        };
    }

    private static bool ParseUseSpritesFlag()
    {
        var rawValue = global::System.Environment.GetEnvironmentVariable(UseSpritesEnvVar);
    ...
    private static Texture2D MakeLog()
    {
        var image = NewImage();
        FillRect(image, new Rect2I(0, 0, Size, Size), new Color(0, 0, 0, 0));
        FillRect(image, new Rect2I(10, 24, 44, 16), new Color(0.50f, 0.31f, 0.13f));
        FillRect(image, new Rect2I(6, 24, 8, 16), new Color(0.80f, 0.68f, 0.44f));
        FillRect(image, new Rect2I(50, 24, 8, 16), new Color(0.80f, 0.68f, 0.44f));
        return CreateOutlinedTexture(image, new Color(0.24f, 0.14f, 0.05f, 0.95f));
    }
    ...
    private static Texture2D MakePlank()
    {
        var image = NewImage();
        FillRect(image, new Rect2I(0, 0, Size, Size), new Color(0, 0, 0, 0));
        FillRect(image, new Rect2I(12, 20, 40, 8), new Color(0.72f, 0.50f, 0.23f));
        FillRect(image, new Rect2I(12, 32, 40, 8), new Color(0.66f, 0.44f, 0.19f));
        return CreateOutlinedTexture(image, new Color(0.28f, 0.18f, 0.07f, 0.95f));
    }
    ...
    private static Texture2D MakeSeeds()
    {
        var image = NewImage();
        FillRect(image, new Rect2I(0, 0, Size, Size), new Color(0, 0, 0, 0));
        FillRect(image, new Rect2I(20, 30, 4, 6), new Color(0.72f, 0.58f, 0.26f));
        FillRect(image, new Rect2I(26, 24, 4, 6), new Color(0.84f, 0.72f, 0.36f));
        FillRect(image, new Rect2I(32, 32, 4, 6), new Color(0.74f, 0.62f, 0.28f));
        FillRect(image, new Rect2I(38, 26, 4, 6), new Color(0.86f, 0.74f, 0.42f));
        return CreateOutlinedTexture(image, new Color(0.36f, 0.27f, 0.10f, 0.95f));
    }
